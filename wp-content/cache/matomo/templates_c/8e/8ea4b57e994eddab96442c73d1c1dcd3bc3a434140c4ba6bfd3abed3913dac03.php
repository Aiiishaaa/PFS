...
class __TwigTemplate_bca8f194a7a427dc01174026e443a75b744f3bd08aebd9c361eb494b19838164 extends Template
{
    private $source;
    private $macros = [];
     ...
     class=\"piwikSelector borderedControl ";
        ...
        ";
            ...
            ";
                ...
                // line 31
                echo "        ";
            } elseif ((((isset($context["isSuperUser"]) || array_key_exists("isSuperUser", $context) ? $context["isSuperUser"] : (function () { throw new RuntimeError('Variable "isSuperUser" does not exist.', 31, $this->source); })()) && (isset($context["isAdminArea"]) || array_key_exists("isAdminArea", $context))) && (isset($context["isAdminArea"]) || array_key_exists("isAdminArea", $context) ? $context["isAdminArea"] : (function () { throw new RuntimeError('Variable "isAdminArea" does not exist.', 31, $this->source); })()))) {
                // line 32
                echo "            ";
...
<span class=\"icon icon-arrowup\"></span>
{% endif %}
", "@CoreHome/_headerMessage.twig", "/home/prestigegt/www/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_headerMessage.twig");
    }
}
