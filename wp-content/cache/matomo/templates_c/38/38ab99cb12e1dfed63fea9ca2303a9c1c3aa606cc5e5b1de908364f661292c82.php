...
/* @CoreHome/_logo.twig */
class __TwigTemplate_675e865cdfdf4f3a767be6e308d3a93df1ec224e866fc81a52b39100adfccfb4 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (((isset($context["centeredLogo"]) || array_key_exists("centeredLogo", $context)) && (isset($context["centeredLogo"]) || array_key_exists("centeredLogo", $context) ? $context["centeredLogo"] : (function () { throw new RuntimeError('Variable "centeredLogo" does not exist.', 1, $this->source); })()))) {
            echo "center";
        }
        echo "\">
    ";
        // line 2
        if (( !(isset($context["logoLink"]) || array_key_exists("logoLink", $context)) ||  !twig_test_empty((isset($context["logoLink"]) || array_key_exists("logoLink", $context) ? $context["logoLink"] : (function () { throw new RuntimeError('Variable "logoLink" does not exist.', 2, $this->source); })())))) {
            // line 3
            echo "    <a href=\"";
            echo \Piwik\piwik_escape_filter($this->env, (((isset($context["logoLink"]) || array_key_exists("logoLink", $context))) ? (_twig_default_filter((isset($context["logoLink"]) || array_key_exists("logoLink", $context) ? $context["logoLink"] : (function () { throw new RuntimeError('Variable "logoLink" does not exist.', 3, $this->source); })()), "index.php")) : ("index.php")), "html", null, true);
            echo "\" tabindex=\"-1\"
       title=\"";
            // line 4
    ...
    ";
            ...
            // line 12
            echo "        <img src='";
            if ((((isset($context["useLargeLogo"]) || array_key_exists("useLargeLogo", $context))) ? (_twig_default_filter((isset($context["useLargeLogo"]) || array_key_exists("useLargeLogo", $context) ? $context["useLargeLogo"] : (function () { throw new RuntimeError('Variable "useLargeLogo" does not exist.', 12, $this->source); })()), false)) : (false))) {
    ...
    ";
        ...
        // line 14
        echo "        ";
        if (( !(isset($context["logoLink"]) || array_key_exists("logoLink", $context)) ||  !twig_test_empty((isset($context["logoLink"]) || array_key_exists("logoLink", $context) ? $context["logoLink"] : (function () { throw new RuntimeError('Variable "logoLink" does not exist.', 14, $this->source); })())))) {
            // line 15
            echo "    </a>
    ";
        }
...
", "@CoreHome/_logo.twig", "/home/prestigegt/www/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_logo.twig");
    }
}
