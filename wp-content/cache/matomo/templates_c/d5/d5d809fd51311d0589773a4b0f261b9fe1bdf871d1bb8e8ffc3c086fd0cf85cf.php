...
class __TwigTemplate_1cea037fdd59031edf21ecf3b1626a882f5a70e210b8b0a628824976f84fa270 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
            ...
            echo "
                    ";
            // line 35
            if ((0 >= twig_compare((isset($context["actionCount"]) || array_key_exists("actionCount", $context) ? $context["actionCount"] : (function () { throw new RuntimeError('Variable "actionCount" does not exist.', 35, $this->source); })()), 1))) {
                // line 36
                echo "                        ";
            ...
            // line 40
            echo "                    ";
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["visitor"], "getColumn", [0 => "visitDuration"], "method", false, false, false, 40), 0))) {
                echo "- ";
...
{% for visitor in dataTable.getRows() %}
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "/home/prestigegt/www/wp-content/plugins/matomo/app/plugins/Live/templates/_dataTableViz_visitorLog.twig");
    }
}
