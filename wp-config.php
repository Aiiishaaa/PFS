...
define( 'FORCE_SSL_ADMIN', true ); // Rediriger toutes les requêtes HTTP vers HTTPS - iThemes Security > Réglages > SSL > SSL pour l’administration
...
define('DB_NAME','prestigegt06270');

/** MySQL database username */
define('DB_USER','prestigegt06270');

/** MySQL database password */
define('DB_PASSWORD','Aleyahpas06');

/** MySQL hostname */
define('DB_HOST','prestigegt06270.mysql.db');
